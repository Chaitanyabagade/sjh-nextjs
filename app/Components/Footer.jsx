  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        <a className="flex title-font font-medium items-center md:justify-start justify-center">
          <Image className="w-[100px] h-[100px] rounded-full border-2 border-white" src={logo} alt="logo"/>
          <span className="ml-3 text-xl">roboshop</span>
        </a>
        <p className="mt-2 text-sm "> Our Porducts Your Ideas</p>
      </div> 
    ...
    <div className="bg-black">
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        <p className="text-gray-200 text-sm text-center sm:text-left">© 2025 Robo-Shop 
          <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className=" ml-1" target="_blank"></a>
        </p>
